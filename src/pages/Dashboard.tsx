import { LayoutGrid, Users, TrendingUp, Bell } from "lucide-react";
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">5 aplicativos vencem hoje</p>
                  <p className="text-xs text-muted-foreground">Clientes precisam renovar licenças</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>
                <div className="flex-1">
                  <p className="text-sm font-medium">23 pagamentos em atraso</p>
                  <p className="text-xs text-muted-foreground">Verificar status dos clientes</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">João Silva - 5 min atrás</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Maria Santos - 15 min atrás</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Carlos Lima - 30 min atrás</p>
                </div>
              </div>
            </div>
          </CardContent>

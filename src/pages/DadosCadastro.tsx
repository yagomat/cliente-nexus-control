...
import { Plus, Building2, Users, Monitor, Smartphone, Trash2, Edit, DollarSign } from "lucide-react";
...
const DadosCadastro = () => {
  ...
  return (
    <div className="container mx-auto p-4 px-0 py-0">
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  <Input
                    ...
                    maxLength={25}
                  />
                  {novoServidor.length >= 25 && (
                    <p className="text-sm text-red-600 mt-1">
                      Limite de caracteres atingido (25)
                    </p>
                  )}
                </div>
